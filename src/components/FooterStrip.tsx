...
const FooterStrip: React.FC<FooterStripProps> = ({ currentYear, currentMonthIdx, selectedDay, onSelectDay }) => {
    ...
    return (
        <footer className="h-[90px] bg-white border-t border-gray-200 shadow-[0_-4px_15px_rgba(0,0,0,0.05)] z-50 flex flex-col shrink-0">
            <div className="text-center text-[11px] font-bold text-gray-400 uppercase pt-2">
