...
const YearViewPortrait = React.memo<YearViewPortraitProps>(({
                                                  mIdx,
                                                  currentYear,
                                                  isFirstLoad,
                                                  cardStyle,
    ...
    return (
        <div
            ...
            className={clsx(
                'rounded-xl shadow-sm active:scale-[0.98] transition-transform cursor-pointer flex flex-col p-2',
        ...
        >
            ...
            <div
                className={clsx(
                    "grid grid-cols-7 pointer-events-none flex-1 min-h-0 gap-x-0.5",
                )}
                style={{
            ...
            >
                ...
                {weekDayHeaders.map((day, i) => (
                    <div
                        key={i}
                        className={clsx(
                            'text-center font-bold text-[8px]',
                            day.isWeekend
                ...
                {monthData.days.map(d => {
                    ...
                    return (
                        ...
                        >
                            <span
                                className={clsx(
                                    'rounded-full flex items-center justify-center aspect-square w-5 h-5 text-[10px]',
